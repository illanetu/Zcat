...
### 10.1. Оптимизация
- Оптимизировать загрузку изображений (использовать Next.js Image component при необходимости)
- Оптимизировать запросы к AI API (кэширование, debouncing)
- Проверить производительность с помощью Next.js встроенных инструментов
