...
export function downloadPdf(blob, filename) {
  ...
  if (isMobileDevice()) {
    // На Android Chrome blob URL в новой вкладке часто открывается пустой.
    // Переходим в текущей вкладке на blob URL — PDF откроется, сохранить из меню браузера, «Назад» — вернуться.
