...
/** Удаляет окружающие кавычки из строки (для названия) */
function stripTitleQuotes(s) {
...
export function buildParameterCard(formData) {
  ...
  return {
    title: stripTitleQuotes(formData.title) || formData.title.trim(),
